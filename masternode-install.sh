...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='allt.conf'
CONFIGFOLDER='/root/.allt'
COIN_DAEMON='alltd'
COIN_CLI='allt-cli'
COIN_TX='allt-tx'
COIN_PATH='/usr/local/bin/'
OS_VERSION=$(lsb_release -d)
COIN_TGZP='https://github.com/alltransfercoin/allt/releases/download/v1000/linux.zip'
COIN_BOOTSTRAP='https://github.com/alltransfercoin/allt/releases/download/v1000/bootstrap.zip'
COIN_BOOTSTRAP_NAME=$(echo $COIN_BOOTSTRAP | awk -F'/' '{print $NF}')
COIN_TGZ=$(echo $COIN_TGZP | awk -F'/' '{print $NF}')
COIN_NAME='allt'
COIN_NAME_OLD='alltd'
PROJECT_NAME='ALLT (allt)'
COIN_EXPLORER='https://explorer.alltcoin.online/'
COIN_PORT=25878
RPC_PORT=25877
...
#   echo -e "${RED}You are not running the correct Ubuntu version. Installation is cancelled.${NC}"
#   exit 1
# fi
...
cat << EOF > /root/allt-general-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME General Info: ${NC}"
$COIN_CLI getinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/allt-general-info

cat << EOF > /root/allt-fee-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Fee Info: ${NC}"
$COIN_CLI getfeeinfo 100
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/allt-fee-info

cat << EOF > /root/allt-networkinfo
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Network Info: ${NC}"
$COIN_CLI getnetworkinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/allt-networkinfo

cat << EOF > /root/allt-masternode-stats
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
...
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/allt-masternode-stats

cp /root/.bashrc /root/.bashrc.backup
sed '/feestats/d' /root/.bashrc | sed '/networkstats/d' | sed '/mnstats/d' | sed '/alltinfo/d' > /root/tmp
mv /root/tmp /root/.bashrc
echo -e "alias feestats='/root/allt-fee-info'" >> /root/.bashrc
echo -e "alias networkstats='/root/allt-networkinfo'" >> /root/.bashrc
echo -e "alias mnstats='/root/allt-masternode-stats'" >> /root/.bashrc
exec bash
}
...
function important_information() {
 ...
 echo -e "You can also use ${RED}allt-cli getinfo${NC}, ${RED}allt-cli getblockcount${NC}, ${RED}allt-cli getmasternodewinners${NC} and ${RED}allt-cli getblockchaininfo${NC} commands for a nice looking infos.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
